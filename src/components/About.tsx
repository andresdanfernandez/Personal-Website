            ...
            <div className="container max-w-4xl w-full" >
                ...
                <div className="flex justify-center items-center gap-4 mb-6" >
                    ...
                    <div className="flex justify-center text-blue-900 gap-16" >
                        ...
                        <a className="hover:cursor-pointer flex flex-col items-center" target="_blank" href="https://drive.google.com/file/d/16PitZ5x-l53wWwCD4yCIUXpT966J8P6W/view?usp=sharing" >
