            ...
            <div className="container max-w-4xl w-full" >
                <div className=" flex flex-col items-center"  >
                    ...
                    <div className="flex justify-center text-blue-900 gap-16" >
                        ...
                        <a className="hover:cursor-pointer flex flex-col items-center" target="_blank" href="https://drive.google.com/file/d/1d1quwH5uuH18XxjI6-BM1Gr4PUldOc2V/view?usp=sharing" >
